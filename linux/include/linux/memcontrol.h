...
struct mem_cgroup {
	...
	/* Phase 1.B: dual histogram (DRAM/NVM 各一套，仅维护，决策不读) */
	...
	/* Phase 1.B: dual cooling clock (Phase 1 与 cooling_clock 同步推进) */
	unsigned int dram_cooling_clock;
	unsigned int nvm_cooling_clock;
